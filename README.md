# Send-IT-API (UI and API)  [![Coverage Status](https://coveralls.io/repos/github/Kabalisa/Send-IT-API/badge.svg?branch=develop)](https://coveralls.io/github/Kabalisa/Send-IT-API?branch=develop)
